...
public class ShopRepo {
    ...
    private void loadProducts(){
        ...
        productList.add(new Product(UUID.randomUUID().toString(), "Aladdin", 32, true, "https://firebasestorage.googleapis.com/v0/b/tktpl-2aef8.appspot.com/o/Aladdin.jpg?alt=media&token=d2c10edf-a6a4-41fd-a0a4-15f1f36e7bc6"));
        ...
        productList.add(new Product(UUID.randomUUID().toString(), "Tangled", 39, true, "https://firebasestorage.googleapis.com/v0/b/tktpl-2aef8.appspot.com/o/Tangled.jpg?alt=media&token=d653cb2d-0f19-4e2c-b120-b0262ae0cb0b"));
